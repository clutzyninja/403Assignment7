...
def createFourArgsRectangle():
    try:
        ...
        print(
            "FAIL: When creating a Rectangle with the following constructor: Rectangle(10,20,1,2), got an exception: " + "\n\n".join(
                traceback.TracebackException.from_exception(e).format()) + "\n")
...
def testRectProperties():
    try:
        ...
        if height != 10:
            print(
                "FAIL: When creating a Rectangle with the following constructor: Rectangle(10,20,1,2), we expected height to be 10 but was: " + str(
                    height) + "\n")
            return
        if width != 20:
            print(
                "FAIL: When creating a Rectangle with the following constructor: Rectangle(10,20,1,2), we expected width to be 20 but was: " + str(
                    width) + "\n")
            return
        if x != 1:
            print(
                "FAIL: When creating a Rectangle with the following constructor: Rectangle(10,20,1,2), we expected x to be 1 but was: " + str(
                    x) + "\n")
            return
        if y != 2:
            print(
                "FAIL: When creating a Rectangle with the following constructor: Rectangle(10,20,1,2), we expected y to be 2 but was: " + str(
                    y) + "\n")
            return
...
def createTwoArgsRectangle():
    try:
        ...
        if x != 0:
            print(
                "FAIL: When creating a Rectangle with the following constructor: Rectangle(10,20), we expected x to be 0 but was: " + str(
                    x) + "\n")
            return
        if y != 0:
            print(
                "FAIL: When creating a Rectangle with the following constructor: Rectangle(10,20), we expected y to be 0 but was: " + str(
                    y) + "\n")
            return
        ...
        print(
            "FAIL: When creating a Rectangle with the following constructor: Rectangle(10,20), got an exception: " + "\n\n".join(
                traceback.TracebackException.from_exception(e).format()) + "\n")
...
def getRectList(aList):
    if aList == "25":
        ...
        return [Rectangle(75, 75), Rectangle(25, 25), Rectangle(50, 50), Rectangle(100, 100), Rectangle(61, 61),
                Rectangle(75, 75), Rectangle(25, 25), Rectangle(50, 50), Rectangle(100, 100), Rectangle(61, 61)]
    elif aList == "75":
        return [Rectangle(75, 75), Rectangle(25, 25), Rectangle(50, 50), Rectangle(100, 100), Rectangle(61, 61),
                Rectangle(75, 75), Rectangle(25, 25), Rectangle(50, 50), Rectangle(100, 100), Rectangle(61, 61),
                Rectangle(45, 125), Rectangle(25, 25), Rectangle(125, 20), Rectangle(50, 200), Rectangle(61, 61)]
    elif aList == "95":
        return [Rectangle(75, 75), Rectangle(25, 25), Rectangle(50, 50), Rectangle(100, 100), Rectangle(61, 61),
                Rectangle(45, 125), Rectangle(25, 25), Rectangle(125, 20), Rectangle(50, 200), Rectangle(61, 61),
                Rectangle(45, 125), Rectangle(25, 25), Rectangle(125, 20), Rectangle(50, 200), Rectangle(61, 61),
                Rectangle(50, 50), Rectangle(50, 50), Rectangle(50, 50), Rectangle(50, 50), Rectangle(50, 50),
                Rectangle(25, 25), Rectangle(25, 25), Rectangle(25, 25), Rectangle(25, 25)]
    else:
        return []
...
def rectInBounds(aRect, aCanvas):
    ...
    # Top Right
        ...
        inBounds = False
    # Bottom Right
    elif (aRect.x + aRect.width) < 0 or (aRect.x + aRect.width) > cWidth or (aRect.y + aRect.height) < 0 or (
            aRect.y + aRect.height) > cHeight:
        inBounds = False
                ...
                if functools.reduce(lambda a, b: a == b, [isinstance(rect, Rectangle) for rect in outputList]):
                    for i, rect in enumerate(outputList):
                        if rectEquality(rect, Rectangle(20, 20)) == False:
                            print(
                                "FAIL: Returned Rectangle was not logically equlivant to given rectangle at index " + str(
                                    i) + "\n")
                            return
                else:
...
def testFill(aFill):
    ...
    try:
        ...
        if len(outputList) != len(getRectList(aFill)):
            print("FAIL: Calling pack given the " + aFill + "% fill, we got " + str(
                len(outputList)) + " Rectangles but expected " + str(len(getRectList(aFill))) + "\n")
            return
            ...
            for rect2 in outputList:
                if rect1.bounds != rect2.bounds:
                    if rect1.within(rect2):
                        print("FAIL: Rectangle with bounds " + str(rect1.bounds) + " intersects with rectangle " + str(
                            rect2.bounds) + "\n")
                        return
